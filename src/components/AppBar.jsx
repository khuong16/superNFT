...
export default function PrimarySearchAppBar() {
  ...
  return (
    <Box sx={{ flexGrow: 1, width:"100%", display:"flex", position: "fixed", top: 0 , marginBottom: 12, zIndex: 9999, backgroundColor:"#f3f6f8"}}>
      <AppBar sx={{ backgroundColor:"#f3f6f8", position: "static", color: "#535353" }}>
        <Toolbar>
          <Button 
            variant="text"
            color="inherit"
